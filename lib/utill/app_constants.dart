...
class AppConstants {
  ...
  static const String TOP_SELLER = '/api/v1/seller/all';
  ...
  // review
  static const String GET_REVIEW = '/api/v1/surveys';
  static const String SUBMIT_REVIEW = '/api/v1/add-survey';

  static const String GET_BIODATA = '/api/v1/biodatas';
  static const String ADD_BIODATA = '/api/v1/add-biodata';
  static const String PIN_CODE = '/api/v1/pincodes';
